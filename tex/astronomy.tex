...
% To do:
% envelopes for deep sky lab

% Maybe later:
%  LST determination
%  following planets through constellations

% Each year:
%  redo weekly outlook in syllabus x
%  redo planet locations in Lab #1 x
%  remind Salvati about GP late lab finish (7pm)
...
\stepcounter{thelabs}
\noindent
{\hfill \Large {\bf Outdoor Lab \#\labnum: Finding an object \#1} \hfill}
\input{findobject_text}

\cleardoublepage
\stepcounter{thelabs}
\noindent
{\hfill \Large {\bf Outdoor Lab \#\labnum: Finding an object \#2} \hfill}
\input{findobject_text}
